...
export default function LobbyPage({ state, onEnter }: Props) {
  ...
  const blueBtn = "border border-tools-blue/35 text-tools-blue bg-tools-blue/6 hover:bg-tools-blue/14";
  const redBtn = "border border-tools-red/35 text-tools-red bg-tools-red/6 hover:bg-tools-red/14";
  const neutralBtn = "border border-tools-border text-tools-text-muted bg-transparent hover:border-tools-border-bright hover:text-tools-text";
      ...
      <div className="w-full max-w-150">
        ...
        <div className="bg-tools-bg2 border border-tools-border rounded-2xl p-6 mb-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className={`${baseBtn} ${blueBtn} self-start`} onClick={() => copy(blueUrl, "blue")}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className={`${baseBtn} ${redBtn} self-start`} onClick={() => copy(redUrl, "red")}>
        ...
        <div className="bg-tools-bg2 border border-tools-border rounded-2xl p-6 mb-4">
          ...
          <div className="flex gap-2.5 flex-wrap">
            <button className={`${baseBtn} ${blueBtn} flex-1 min-w-30`} onClick={() => onEnter("blue")}>
              Enter as {state.blueName}
            </button>
            <button className={`${baseBtn} ${redBtn} flex-1 min-w-30`} onClick={() => onEnter("red")}>
              Enter as {state.redName}
            </button>
            <button className={`${baseBtn} ${neutralBtn} flex-1 min-w-30`} onClick={() => onEnter("spectator")}>
              Spectate
            </button>
          </div>
        </div>
