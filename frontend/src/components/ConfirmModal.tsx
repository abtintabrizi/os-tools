...
export default function ConfirmModal({
  ...
  return (
    ...
    >
      <div className="bg-tools-carbon border border-white/15 rounded-2xl p-8 max-w-90 w-[90%] text-center">
        <div
        ...
        <div className="text-2xl font-extrabold mb-6">{map}</div>
        <div className="flex gap-2.5">
          <button
            className="flex-1 py-3 px-3 rounded-lg border border-white/7 font-head text-sm font-bold transition-all duration-150 bg-transparent hover:border-white/15"
            onClick={onCancel}
          >
            Cancel
          </button>
